...
$(document).ready(function () {
  ...
  /* color style picker */
  if (
    $.type($.cookie('stylesheet2')) != 'undefined' &&
    $.cookie('stylesheet2') != ''
  ) {
    ...
    $('.colorselect').each(function () {
      ...
      if (
        activestyle.next('label').attr('data-title') === $.cookie('stylesheet2')
      ) {
  ...
  /* round layout layout */
  if (
    $.type($.cookie('darklayout')) != 'undefined' &&
    $.cookie('darklayout') != ''
  ) {
  ...
  /* RTL layout layout */
  if (
    $.type($.cookie('rtllayout')) != 'undefined' &&
    $.cookie('rtllayout') != ''
  ) {
