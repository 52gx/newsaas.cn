$(function(){
    ...
    content +='<div class="qq-hover-c"><img class="img-qq" src="https://cdn.jsdelivr.net/gh/1000gcc/newsaas.cn@master/assets/kefu/qq.png"></div>';
    ...
    content +='<div class="tel-num"><a href="https://newsaas.cn" target="_blank" title="Home">[官网]</a><a href="https://www.newsaas.cn/user?action=ticket-new" target="_blank" style="margin-left:5px;" title="Feed">[反馈]</a><br /><a href="https://bbs.newsaas.cn" target="_blank" style="margin-left:5px;" title="点击查看">聪明的同学点这里</a></div>';
    content +='</div>';
    ...
    content +='<img class="weixing-ma" src="https://cdn.jsdelivr.net/gh/1000gcc/newsaas.cn@master/assets/kefu/qr_gzh.jpg">';
